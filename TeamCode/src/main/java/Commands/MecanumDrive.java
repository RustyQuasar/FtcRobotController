...
public class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 58.25 / 100000;
        public double lateralInPerTick = 58.25 / 100000;
        public double trackWidthTicks = 582184.1434061086;

        // feedforward parameters (in tick units)
        public double kS = 1.836041122070018;
        public double kV = 0.00009743247670141175;
        ...
        public double lateralGain = 1.55;
        public double headingGain = 0.14; // shared with turn

        public double axialVelGain = 0;
        public double lateralVelGain = 0;
        public double headingVelGain = 0.02; // shared with turn
    }
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            p.put("x", Constants.OdometryConstants.fieldPos.position.x);
            p.put("y", Constants.OdometryConstants.fieldPos.position.y);
            p.put("heading (deg)", Math.toDegrees(Constants.OdometryConstants.fieldPos.heading.toDouble()));

            Pose2d error = txWorldTarget.value().minusExp(Constants.OdometryConstants.fieldPos);
            ...
            c.setStroke("#3F51B5");
            Drawing.drawRobot(c, Constants.OdometryConstants.fieldPos);
